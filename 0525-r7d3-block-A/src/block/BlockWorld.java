...
class BlockWorld extends World {
	...
	public void onTick() {
		...
		if (this.falling.landed(this.fixed)) { //TODO: implement this condition ************************
			...
			if (this.falling.overlap(this.next)) {
				...
				return new BlockWorld(this.next, this.fixed.append(this.falling), this.third, this.next); //TODO: implement this expression ***************
			}
		} else {
			// the falling piece can fall
			return new BlockWorld(this.falling.down(), this.fixed,
	...
	boolean drawBackground(Canvas c) {
		return c.drawRect(new Posn(0, 0), 
