...
public class SnakeWorldExamples {
	...
	Snake h1a = new Snake(new Position(2,1), east,
			...
			new ConsBody(new Node(new Position( 0, 1)),
					new MTBody())));
		IApples a1 = 
				new ConsApples(new Apple(new Position(9,7)),
				new ConsApples(new Apple(new Position(5,9)),
				new MTApples()));
	...
	Snake h2a = new Snake(new Position(0,10), south,
			...
			new ConsBody(new Node(new Position(1,8)),
					new MTBody()))));
	IApples a2 = 
			new ConsApples(new Apple(new Position(9,9)),
			new ConsApples(new Apple(new Position(0,0)),
			new ConsApples(new Apple(new Position(0,9)),
			new MTApples())));
