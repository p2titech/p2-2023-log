...
public class Snake {
	...
	public Snake change(String key) {
		if(key.equals("LEFT")) {
			return new Snake(this.headLocation,this.body,new DirLeft());
		}
		else if(key.equals("RIGHT")) {
			return new Snake(this.headLocation, this.body, new DirRight());
		}
		else if(key.equals("UP")) {
			return new Snake(this.headLocation, this.body, new DirUp());
		}
		else if(key.equals("DOWN")){
			return new Snake(this.headLocation, this.body, new DirDown());
		}
		else {
			return this;
		}
